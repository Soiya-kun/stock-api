...
// Source: usecase/interactor/userintf.go
...
import (
	...
	interactor "gitlab.com/soy-app/stock-api/usecase/interactor"
)
...
func (m *MockIUserUseCase) Create(user interactor.UserCreate) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockIUserUseCase) FindByIDByAdmin(userID string) (entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByIDByAdmin", userID)
	ret0, _ := ret[0].(entity.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIUserUseCaseMockRecorder) FindByIDByAdmin(userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByIDByAdmin", reflect.TypeOf((*MockIUserUseCase)(nil).FindByIDByAdmin), userID)
}
...
func (m *MockIUserUseCase) Update(arg0 interactor.UserUpdate) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserUseCaseMockRecorder) Update(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIUserUseCase)(nil).Update), arg0)
}

// UpdatePassword mocks base method.
func (m *MockIUserUseCase) UpdatePassword(arg0 interactor.UserUpdatePassword) error {
	m.ctrl.T.Helper()
